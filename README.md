...
The core child carries 40 groups (the 11 pre-Batch-6 grafts plus
...
allocator after `class->lock` is dropped); the
...
`psi_oncpu_state_mask`); the display child carries 1, for 64 groups in total.
